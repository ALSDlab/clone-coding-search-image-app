...
MainEvent _$MainEventFromJson(Map<String, dynamic> json) {
  switch (json['runtimeType']) {
    case 'showSnackBar':
      return ShowSnackBar.fromJson(json);
    case 'showDialog':
      return ShowDialog.fromJson(json);

    default:
      throw CheckedFromJsonException(json, 'runtimeType', 'MainEvent',
...
class _$ShowSnackBarImpl with DiagnosticableTreeMixin implements ShowSnackBar {
  const _$ShowSnackBarImpl(this.message, {final String? $type})
      : $type = $type ?? 'showSnackBar';

  factory _$ShowSnackBarImpl.fromJson(Map<String, dynamic> json) =>
      _$$ShowSnackBarImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$ShowSnackBarImplToJson(
      this,
    );
  }
}
...
abstract class ShowSnackBar implements MainEvent {
  ...
  factory ShowSnackBar.fromJson(Map<String, dynamic> json) =
      _$ShowSnackBarImpl.fromJson;
...
class _$ShowDialogImpl with DiagnosticableTreeMixin implements ShowDialog {
  const _$ShowDialogImpl(this.message, {final String? $type})
      : $type = $type ?? 'showDialog';

  factory _$ShowDialogImpl.fromJson(Map<String, dynamic> json) =>
      _$$ShowDialogImplFromJson(json);
...
abstract class ShowDialog implements MainEvent {
  ...
  factory ShowDialog.fromJson(Map<String, dynamic> json) =
      _$ShowDialogImpl.fromJson;
